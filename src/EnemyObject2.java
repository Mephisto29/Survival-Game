...
public class EnemyObject2 extends EnemyObject 
{
    ...
    public EnemyObject2(float x, float y){
    	super(x,y);
    }
    public EnemyObject2(float x, float y, float m, GameTexture enemyTexture, PlayerObject player) 
    {
    	super (x, y, m, enemyTexture,player);
